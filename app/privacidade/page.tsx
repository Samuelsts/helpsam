...
const sections = [
  {
    title: '1. Quem somos',
    body: 'Esta é uma plataforma independente de tutoriais, disponível em help.samlabs.com.br, criada voluntariamente por um colaborador para auxiliar usuários do sistema Clinic All / Focus. Não somos um canal oficial da empresa.',
  },
  {
