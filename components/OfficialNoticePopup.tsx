    ...
    >
      <section className="animate-scale-in w-full max-w-2xl rounded-3xl border border-white/70 bg-white p-6 shadow-2xl shadow-slate-950/20 sm:p-8">
        ...
        <div className="mt-6 space-y-4 text-sm leading-6 text-slate-600">
          <p>
            Esta plataforma é um material <strong>independente</strong>, criado
            voluntariamente por um colaborador com fins exclusivamente
          ...
          <p>
            ...
            <strong>canais oficiais de atendimento</strong> da Focus/Clinic All.
          </p>

          <ul className="list-disc space-y-1 pl-5">
            <li>
              Os materiais <strong>não podem</strong> ser baixados, copiados ou
              comercializados.
            </li>
            <li>
          ...
          <p>
            Ao acessar esta plataforma, você declara estar ciente do seu caráter
            independente e concorda com os{' '}
